...
\begin{document}
	...
	\section{Die ersten Tage}
		\input{texte/erstetage/ersticheckliste\termPostfix}
	...
	\section{Spezielles im Bachelor}
		\label{bachelor}
		\begin{multicols}{2}
		\input{texte/bachelor/profs\termPostfix}
		\input{texte/bachelor/studienplan\termPostfix}
		\input{texte/bachelor/quovadis\termPostfix}
		\end{multicols}
		\input{texte/bachelor/musterstudienplan_\termPostfix}
