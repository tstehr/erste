...
\item Theoretische Informatik 1 - 5 Credits
%\item Stochastik - 5 Credits
%\item Einführung in die Psycholgoie - 5 Credits \footnote{Dies ist
 %   allerdings geraten, da zum Modul noch zwei andere Prüfungen
 %   gehören, mehr dazu im vierten Semester ;)}.
\item Geschichte der Mathematik- 5 Credits
...
manchmal sehr ,,verplant'' \footnote{Wir entschuldigen uns für dieses
...
\end{multicols}\newpage
\begin{figure}[p]
  \centering\includegraphics[angle=90,totalheight=\textheight ]{texte/bachelor/studienplan_joke.pdf}
\end{figure}
\begin{multicols}{2}
