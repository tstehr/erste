...
% \begin{figure}[h]
%   \centering\includegraphics[width = 0.7\linewidth]{bilder/otto1_1.png}
% \end{figure}
...
% \begin{figure}[h]
%   \centering\includegraphics[width = 0.7\linewidth]{bilder/otto1_2.png}
% \end{figure}
...
% \begin{figure}[h]
%   \centering\includegraphics[width = 0.7\linewidth]{bilder/otto1_3.png}
% \end{figure}
