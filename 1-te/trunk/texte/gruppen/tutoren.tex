...
\begin{figure}[h]
  \subfloat[Hella 3\newline h-f.hoffmann@tu-bs.de]{\includegraphics[width=0.25\linewidth]{bilder/tutoren/hella}}
  \hfill
  \subfloat[Hella 4]{\includegraphics[width=0.25\linewidth]{bilder/tutoren/hella}}
  \hfill
  \subfloat[Hella 5]{\includegraphics[width=0.25\linewidth]{bilder/tutoren/hella}}
  \caption*{Tutoren}
\end{figure}
