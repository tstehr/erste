...
\begin{figure}[h]
  \subfloat[Hella\newline 3.Semester\newline h-f.hoffmann@tu-bs.de]{\includegraphics[width=0.21\linewidth]{bilder/tutoren/hella}}
  \hfill
  \subfloat[xyz\newline 40.Semester\newline xyz@tu-bs.de]{\includegraphics[width=0.21\linewidth]{bilder/tutoren/hella}}
  \hfill
  \subfloat[Tutor 2]{\includegraphics[width=0.21\linewidth]{bilder/tutoren/hella}}
  \caption*{Tutoren}
\end{figure}
