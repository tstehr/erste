...
Jedem Ersti soll in der Einführungswoche (s. Termine)[VERKN"UPFUNG] eine Tutorengruppe zugeteilt werden. Damit auch ihr wisst, an wen ihr euch wenden k"onnt, solltet ihr diese Einteilung und das anschlie"sende erste Treffen nicht verpassen!\\
...
% \begin{figure}[h]
% 	\centering\includegraphics[width=0.3\linewidth]{bilder/hella.png}\\
% 	\small{Hella\\ \nurl{h-f.hoffmann@tu-bs.de}}
% \end{figure}
