...
\begin{figure}[h]
  \subfloat[Hella 1]{\includegraphics[width=0.3\linewidth]{bilder/tutoren/hella}}
  \hfill
  \subfloat[Hella 2]{\includegraphics[width=0.3\linewidth]{bilder/tutoren/hella}}
\end{figure}

\begin{figure}[h]
  \subfloat[Hella 3]{\includegraphics[width=0.3\linewidth]{bilder/tutoren/hella}}
  \hfill
  \subfloat[Hella 4]{\includegraphics[width=0.3\linewidth]{bilder/tutoren/hella}}
  \hfill
  \subfloat[Hella 5]{\includegraphics[width=0.3\linewidth]{bilder/tutoren/hella}}
  \caption*{Tutoren}
\end{figure}
