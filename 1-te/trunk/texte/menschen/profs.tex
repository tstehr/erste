...
\begin{figure}[h]
	\centering\includegraphics[width=0.7\linewidth]{bilder/struck.png}\\
...
% 	{Dr. Ira Diethelm}
% \end{figure}
Hier werden Methoden und Richtlinien behandelt, die man zum Erstellen wissenschaftlicher Arbeiten benötigt.