...
gibt es zwei Streckenlisten  auf der Seite \pageref{streckenliste1}.
...
\includegraphics[width=\columnwidth]{bilder/ticket_deutschland}

\end{multicols}
%\includegraphics[scale=0.5]{bilder/ticket_deutschland}
\includegraphics[width=\textwidth]{bilder/ticket_bis_11_Dezember}
