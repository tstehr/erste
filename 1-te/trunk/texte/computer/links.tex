...
%TODO Wenn man diesen Text so liest, so kommt es so rüber als wäre Sags uns eine Frageplatform für mehr oder weniger "dumme Fragen", aber ich hatte es bisher eher als Plattform für Kritik und Verbesserungsvorschläge angesehen, also eine Art Bug-Tracker fürs Studium. Was ist denn nun richtig? Zudem steht hier, dass es ein Blog wäre. Dominik?
