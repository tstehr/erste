\begin{stundenplan}{18}{9}{8}{00}{16}{00} % width, height, starth, startmin, endh, endmin
	...
	\termin{Programmieren (V)}{
		Tentomax\footref{rooms}, \emph{Übungstermin fehlt!
			\footnote[2]{Der Termin für die zugehörige Übung stand zum Druckzeitpunkt noch nicht fest. Wir informieren so bald wie möglich über den Termin.}
		}
	}{2}{8}{00}{9}{30}{vlTermin}
	...
	\Termin{Treffen der Medizininformatiker}{
		15:00, IZ 404\footref{rooms}, \emph{
			Nur für Medizininformatikstudierende.
			\footnote[3]{Um Anmeldung bei wird gebeten. Wenn du Medizininformatik studierest und teilnehmen willst, schicke eine Mail an ute.zeisberg@plri.de}
		}
	}{3}{14}{15}{16}{00}{uniTermin}


	\termin{Algebra (Ü)}{PK 2.2\footref{rooms}}{4}{8}{00}{9}{30}{vlTermin}
	%\termin{Programmieren (Ü)}{SN 19.1\footref{rooms}}{4}{8}{00}{9}{30}{vlTermin}
