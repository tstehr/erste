...
\label{todogitz}
	...
	\subsubsection{WLAN}
		\label{wlan}
		WLAN wird vom Rechenzentrum praktisch auf dem ganzen Campus angeboten. Alle notwendigen Informationen, um das \emph{eduroam} nutzen zu können, findest du auf folgender Website: \verUrl{8}{http://www.tu-braunschweig.de/it/dienste/11/1106}
    ...
    Die Eintellungen dafür verrät das GITZ als \enquote{Parameter (Experten)}\footnote{\verUrl{8}{https://doku.rz.tu-bs.de/doku.php?id=netz:wlan:wlan_einrichten}}.
    ...
    Schau einfach mal auf den Seiten des GITZ\footnote{\verUrl{8}{https://www.tu-braunschweig.de/it/dienste/11/1105}} nach, um mehr zu erfahren.
