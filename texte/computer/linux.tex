...
\subsection{Linux}
	...
	\subsubsection{Linux-Bezug an der TU}
		...
		\begin{description}
			\item[\verUrl{5}{http://www.knopper.net/knoppix-mirrors/}]~\\Offizielle Download-Seite für die Linux-Distribution Knoppix, welche einfach von einer CD oder einem USB-Stick gestartet werden kann
			\item[\verUrl{5}{http://debian.tu-bs.de/}]~\\Debian-, Kanotix- und Knoppixmirror, schön schnell aus dem Uni-Netz
			\item[\verUrl{5}{https://www.ibr.cs.tu-bs.de/kb/services.html}]~\\Verschiedene Online-Dienste des IBR
		\end{description}
