...
\subsection{Linux}
	...
	Die Fachgruppe bietet im Rahmen der O-Woche eine Linux-Install-Party an, auf der du unter Anleitung und mit Unterstützung von erfahrenen Linux-Nutzern dein eigenes Linux installieren kannst. Sie findet dieses Semester am 09.04 um 16:45 Uhr im IZ~160 statt. \tocheck{5}{Wann findet die Linux-Install-Party dieses Semester statt?}
	...
	\subsubsection{SSH -- Zugriff aus der Ferne}
		...
		\begin{description}
			\item[Putty] stellt dir eine Shell auf dem UNIX-Rechner bereit. Damit kannst du so auf deinem Rechner arbeiten, als würdest du direkt auf dem Server arbeiten (tust du ja auch).  Download: \verUrl{5}{http://www.putty.org/}
			\item[Xming] Um auch grafische Programme starten zu können, musst du noch einen X-Server für Windows
			  installieren, z.B. Xming. Download: \verUrl{5}{http://sourceforge.net/projects/xming/}
		\end{description}
	...
	\subsubsection{Linux-Bezug an der TU}
		...
		\begin{description}
			\item[\verUrl{5}{http://www.knopper.net/knoppix-mirrors/}]~\\Enthält Openoffice"~, Mozilla"~, Gentoo"~, Slackware- und Ubuntumirror, CCC-Vorträge
			\item[\verUrl{5}{http://debian.tu-bs.de/}]~\\Debian-, Kanotix- und Knoppixmirror
			\item[\verUrl{5}{https://www.ibr.cs.tu-bs.de/kb/services.html}] Mehr CCC-Vorträge, diverse freie Software (größtenteils für Unix/Linux)
		\end{description}
