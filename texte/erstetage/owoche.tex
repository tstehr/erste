...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Weitere Informationen und das Anmeldeformular findest du auf unserem Blog unter dem Reiter "Erstsemester" \footnote{\verUrl{4}{https://fginfo.cs.tu-bs.de/wiki/doku.php?id=infos:studium:erstsemester}}
	\end{itemize}
\end{itemize}