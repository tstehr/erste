...
\begin{itemize}
    ...
    \item Ersti-Wochenende
        \begin{itemize}
            ...
            \item Die Anmeldung ist online möglich, den Link zur Anmeldung findest du auf unserer Webseite\footnote{\verUrl{7}{https://fginfo.cs.tu-bs.de/ersti}}
        \end{itemize}
\end{itemize}
