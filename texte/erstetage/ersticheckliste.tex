...
\subsubsection{BAföG}
	...
	\verUrl{3}{http://www.bafoeg.bmbf.de/}
...
\subsubsection{Prüfungsanmeldung}
	...
	Du musst dich für alle Prüfungen, an denen du teilnehmen willst, vorher beim Prüfungsamt anmelden. Die Fristen sind relativ früh im Semester. Die Termine werden im Laufe des Semesters veröffentlicht (Seiten des P-Amtes (\verUrl{3}{https://www.tu-braunschweig.de/fk1/service/informatik/pa}), Mailingliste). Prüfungen können während der Prüfungsanmeldezeitraums schriftlich im Prüfungsamt angemeldet werden oder online über das QIS-Portal.
...
\subsubsection{TUcard}
	...
	Weitere Informationen zur TUcard findet ihr unter: \verUrl{3}{https://www.tu-braunschweig.de/studium/imstudium/tucard}
