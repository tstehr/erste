...
Du hälst ein Exemplar der zweiten, nachgedruckten Auflage in
deinen Händen. Darin sind bereits viele Fehler behoben,
die wir Ende September noch abgedruckt und an deine
Kommilitonen ausgeteilt haben. Dennoch können wir natürlich
auch hier nicht alle Fehler ausschließen.

Falls wir also noch etwas nachbessern müssen, findest du es unter \url{http://fginfo.cs.tu-bs.de/}. Dort % TODO evtl. hier einen Deeplink, etwa http://fginfo.cs.tu-bs.de/erste oder sowas
