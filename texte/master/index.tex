...
\begin{multicols}{2}
	...
	\subsection{Unterschiede zwischen den Bachelor-Abschlüssen}
		...
		Falls du von einer Nicht-Universität (z.B. Fachhochschule) oder aus einem Studiengang der nicht exakt \emph{Informatik} heit kommst oder dein Abschluss kein Bachelor of Science ist, dann kann es durchaus sein, dass du, bei gewissen Unterschieden, Zulassungsauflagen bekommst, um diese zu beheben.
