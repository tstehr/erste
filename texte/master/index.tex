...
\begin{multicols}{2}
	...
	Viele Fragen zu den Zulassungsauflagen sind unter \verUrl{4}{https://fginfo.cs.tu-bs.de/wiki/infos:faq} dokumentiert und nach bestem Wissen und Gewissen beantwortet. Falls du eine Auflage erhalten hast, die dir fragwürdig erscheint oder du sonst irgendwelche Fragen dazu hast, wende dich am besten an den Fachgruppenrat.
	...
	\subsection{Der eigene Stundenplan}
		...
		\xkcd{totalheight=6cm}{sandwich}
		
	\subsubsection{Hilfe beim Stundenplanbau}
		\tocheck{4}{Wann findet der Workshop diese Jahr statt?}
		Wir bieten seit einigen Semestern zu Beginn Hilfe beim Stundenplanbau an. Dieses Mal findet der Workshop am Dienstag, 17.10.2017 ab 13:45 statt (Treffpunkt: vor dem Fachgruppenraum). 
\end{multicols}
