...
\begin{multicols}{2}
	...
	Viele Fragen zu den Zulassungsauflagen sind unter \verUrl{8}{https://wiki.fginfo.tu-bs.de/doku.php?id=infos:faq} dokumentiert und nach bestem Wissen und Gewissen beantwortet. Falls du eine Auflage erhalten hast, die dir fragwürdig erscheint oder du sonst irgendwelche Fragen dazu hast, wende dich am besten an den Fachgruppenrat.
	...
	\subsubsection{Hilfe beim Stundenplanbau}
		\tocheck{8}{Wann findet der Workshop diese Jahr statt?}
		Wir bieten seit einigen Semestern zu Beginn Hilfe beim Stundenplanbau an. Dieses Mal findet der Workshop am Dienstag, 14.10.19 ab 11:00 Uhr statt (Treffpunkt: IZ 160). 
