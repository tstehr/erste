...
\subsection{Ansprechpartner}
	\tocheck{2}{Infos zu Personen gegenchecken}
	...
	\paragraph{Fachgruppenrat}
		...
		\\
		\\
		Tipp: In der Stunde vor dem Treffen füllt sich der Raum schon langsam, also hast du da gute Chancen, Probleme in kleinerer Runde zu besprechen. Ansonsten erreichst du uns natürlich via Email unter \verHref{2}{mailto:fginfo@tu-bs.de}{fginfo@tu-bs.de}. 
	...
	\paragraph{Fachspezifisches}
		...
		oder über die Personensuche unter \verUrl{2}{http://www.tu-braunschweig.de/suchoptionen/personen}.
	...
	\paragraph{Studiengangskoordinatorin}
		...
		E-Mail: \verHref{2}{mailto:informatik-studium@tu-bs.de}{informatik-studium@tu-bs.de}
	...
	\paragraph{Fachstudienberater}
		...
		E-Mail: \verHref{2}{mailto:struck@ips.cs.tu-bs.de}{struck@ips.cs.tu-bs.de}\\
	...
	\paragraph{Prüfungsamt}
		...
		Tel.: (0531) 391-2844\\
		Fax: (0531) 391-8220\\
		E-Mail: \verHref{2}{mailto:pa-informatik@tu-braunschweig.de}{pa-informatik@tu-braunschweig.de}\\
