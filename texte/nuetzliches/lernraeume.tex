...
Wenn du im Laufe deines Studiums einen guten Ort findest, kannst du uns den Raum mitteilen, wir überprüfen das und nehmen ihn dann in die Liste auf.. Alle Gebäude stehen, wenn nicht anders in Anlage 1 der Hausordnung der TU Braunschweig erwähnt, von 7:30 bis 19:30 Uhr offen.
	...
	allerdings eher, um euch ,,Wohnzimmer'' vieler
	Informatikstudierenden auch als solches zu empfehlen. Wenn
	ihr irgendwo Hilfe von höheren Semestern braucht, mal eine
	Runde kickern möchtet, oder einfach  etwas chillen, ist der Raum
	sehr zu empfehlen. Außerdem finden da unsere wöchentlichen
	Treffen statt. Das kann man da alles wunderbar machen, nur
	eines kann man dort leider nicht: Lernen! Eben dadurch, dass er als
	sozialer Treffpunkt fungiert, kann man dort sich zwar sehr gut
	in einer Pause hinbegen, gerade wenn der Koffeinhaushalt ein
	bedenkliches Minus erreicht hat. Gleiches
	gilt, wenn man eine Frage hat oder allgemein jemanden zum
	Quatschen sucht.. Ungestörtes Arbeiten ist hingegen
	schwieriger, da man im Allgemeinen eben nicht alleine mit den
	Bedürfnis nach Entspannung ist :) 
