...
\tocheck{5}{Stimmen die Credit-Anzahlen noch mit der BPO überein (sprich, gab es eine neue BPO)?}
...
\tocheck{5}{Beschreibung der Musterstudienpläne aktuell?, ggf. Vorschläge der Fachgruppe aktualisieren und einpflegen}
